...
const Map<String, Map<String, String>> _strings = {
  ...
  'sub_signin_lead': {'ru': 'Подписка живёт на человеке, а не на телефоне: сменили устройство — Pro переезжает с вами. Карточки и статистика остаются на устройстве.', 'en': 'The subscription belongs to you, not to a phone: change your device and Pro comes with you. Cards and progress stay on the device.'},
  'sub_email': {'ru': 'Почта', 'en': 'Email'},
  'sub_password': {'ru': 'Пароль', 'en': 'Password'},
  'sub_password_hint': {'ru': 'Не короче восьми знаков', 'en': 'At least eight characters'},
  'sub_signin': {'ru': 'Войти', 'en': 'Sign in'},
  'sub_signup': {'ru': 'Создать аккаунт', 'en': 'Create account'},
  'sub_no_account': {'ru': 'Аккаунта ещё нет', 'en': 'I don’t have an account yet'},
  'sub_have_account': {'ru': 'Аккаунт уже есть', 'en': 'I already have an account'},
  'sub_forgot': {'ru': 'Забыли пароль', 'en': 'Forgot your password'},
  'sub_reset_sent': {'ru': 'Письмо со ссылкой отправлено', 'en': 'We sent you a link by email'},
  'sub_or': {'ru': 'или', 'en': 'or'},
  'sub_google': {'ru': 'Продолжить с Google', 'en': 'Continue with Google'},
  'sub_apple': {'ru': 'Продолжить с Apple', 'en': 'Continue with Apple'},
  'sub_account_fine': {'ru': 'Аккаунт хранит только оплату. Слова, колоды и прогресс никуда не уезжают.', 'en': 'The account stores your payment only. Words, decks and progress never leave the device.'},
  'sub_err_wrong': {'ru': 'Почта или пароль не подошли', 'en': 'That email or password did not match'},
  'sub_err_taken': {'ru': 'На эту почту аккаунт уже заведён', 'en': 'An account with this email already exists'},
  'sub_err_email': {'ru': 'Проверьте адрес почты', 'en': 'Check the email address'},
  'sub_err_weak': {'ru': 'Пароль короче восьми знаков', 'en': 'The password is shorter than eight characters'},
  'sub_err_net': {'ru': 'Сервер не ответил. Проверьте связь и попробуйте снова', 'en': 'The server did not answer. Check your connection and try again'},
  'sub_err_failed': {'ru': 'Не получилось. Попробуйте ещё раз', 'en': 'That did not work. Try again'},
  'sub_err_checkout': {'ru': 'Счёт не создался. Попробуйте позже', 'en': 'We could not create the invoice. Try later'},
  'sub_err_wait': {'ru': 'Оплата ещё не дошла. Откройте приложение через пару минут — Pro включится сам', 'en': 'The payment has not arrived yet. Open the app in a couple of minutes and Pro will turn on by itself'},
  'sub_plan_year': {'ru': 'На год', 'en': 'Yearly'},
  'sub_plan_month': {'ru': 'На месяц', 'en': 'Monthly'},
  'sub_year_note': {'ru': '{price} в месяц, списание раз в год', 'en': '{price} a month, charged once a year'},
  'sub_month_note': {'ru': 'Списание раз в месяц, отменить можно в любой день', 'en': 'Charged once a month, cancel any day'},
  'sub_subscribe': {'ru': 'Оформить подписку', 'en': 'Subscribe'},
  'sub_have_key': {'ru': 'У меня есть ключ, купленный раньше', 'en': 'I have a key bought earlier'},
  'sub_terms': {'ru': 'Условия использования', 'en': 'Terms of Use'},
  'sub_privacy': {'ru': 'Политика конфиденциальности', 'en': 'Privacy Policy'},
  'sub_fine_store': {'ru': 'Подписка продлевается сама, пока её не отменить в настройках магазина. Деньги списываются со счёта, привязанного к магазину, за сутки до конца срока.', 'en': 'The subscription renews itself until you cancel it in the store settings. The charge goes to the account linked to the store a day before the period ends.'},
  'sub_fine': {'ru': 'Оплата на lava.top. Подписка продлевается сама, отменить можно в настройках в один тап.', 'en': 'Payment goes through lava.top. The subscription renews itself and is cancelled in settings with one tap.'},
  'sub_waiting': {'ru': 'Ждём оплату', 'en': 'Waiting for the payment'},
  'sub_paid_ok': {'ru': 'Fern Pro открыт', 'en': 'Fern Pro unlocked'},
  'sub_section': {'ru': 'Подписка', 'en': 'Subscription'},
  'sub_paid_until': {'ru': 'Оплачено до {date}', 'en': 'Paid until {date}'},
  'sub_cancelled_until': {'ru': 'Отменена, Pro работает до {date}', 'en': 'Cancelled, Pro works until {date}'},
  'sub_expired': {'ru': 'Срок вышел', 'en': 'The subscription has ended'},
  'sub_none': {'ru': 'Подписки нет', 'en': 'No subscription'},
  'sub_lifetime': {'ru': 'Куплено навсегда', 'en': 'Bought forever'},
  'sub_cancel': {'ru': 'Отменить подписку', 'en': 'Cancel subscription'},
  'sub_cancel_ask': {'ru': 'Отменить подписку? Pro будет работать до конца оплаченного срока.', 'en': 'Cancel the subscription? Pro keeps working until the end of the paid period.'},
  'sub_cancel_done': {'ru': 'Подписка отменена', 'en': 'Subscription cancelled'},
  'sub_cancel_failed': {'ru': 'Отменить не вышло. Напишите нам, отменим руками', 'en': 'We could not cancel it. Write to us and we will do it by hand'},
  'sub_signout': {'ru': 'Выйти из аккаунта', 'en': 'Sign out'},
  'sub_signout_ask': {'ru': 'Выйти? Pro на этом устройстве закроется, подписка останется у аккаунта.', 'en': 'Sign out? Pro closes on this device, the subscription stays with the account.'},
  'sub_renew': {'ru': 'Продлить', 'en': 'Renew'},
  ...
  'pro_restore_checking': {'ru': 'Спрашиваем магазин…', 'en': 'Asking the store…'},
  'pro_restore_ok': {'ru': 'Покупка вернулась, Pro открыт', 'en': 'Purchase restored, Pro is on'},
  'pro_restore_nothing': {'ru': 'В этом аккаунте магазина покупки нет', 'en': 'No purchase in this store account'},
  'pro_restore_failed': {'ru': 'Магазин не ответил. Попробуйте ещё раз', 'en': 'The store did not answer. Try again'},
