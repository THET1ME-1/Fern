...
APPS = {
    "fern": {
        ...
        "about": (
            ...
            "🔄 Подписка на месяц или на год — оформляется в приложении"
        ),
        "items": [
            {
                "id": "fern_pro",
                "title": "Fern Pro — подписка",
                "note": "оформляется в приложении: Настройки → Fern Pro",
                "url": "https://github.com/THET1ME-1/Fern/releases/latest",
                "kind": "key",
            },
        ],
    },
